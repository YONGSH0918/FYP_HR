                ...
                <div class="panel-body">
                    <form name="formAddEmployee" class="form-horizontal" role="form" method="POST" action="{{ route('addEmployee') }}" enctype="multipart/form-data" onSubmit="return formValidation();">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="department" name="department" style="width: -webkit-fill-available;" required>
                            </div>
                        </div>
                        <!--Employee Job Title-->
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="jobtitle" name="jobtitle" style="width: -webkit-fill-available;" required>
                            </div>
                        </div>
                        <!--Employee Salary-->
                        <div class="form-group">
                        ...
                        <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="employment_ID" name="employment_ID" style="width: -webkit-fill-available;" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="marital_Status" name="marital_Status" style="width: -webkit-fill-available;" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="bank_Name" name="bank_Name" style="width: -webkit-fill-available;" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="workingSchedule" name="workingSchedule" style="width: -webkit-fill-available;" required>
                                </div>
                            </div>
                            <div class="form-group">
