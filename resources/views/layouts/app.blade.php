...
<head>
    ...
    <script src="formAddEmployee.js" type="text/javascript"></script>
    ...
    <div class="wrapper">
        <nav id="sidebar">
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#page1Submenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">System Management</a>
