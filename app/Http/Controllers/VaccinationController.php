...
class VaccinationController extends Controller
{
    ...
    public function addVA($id)
    {
       ...
       $healthFacility = HealthFacility::all();

       return view('vaccination-mgmt/addVA')->with('employees', $employees)
       ->with('healthFacility', $healthFacility);
    ...
    public function findAddress(Request $request){
        ...
        return response()->json($address)->with('address', $address);
    }
    ...
    {    //step 2 
        ...
        $addCPD = VaccinationInfo::create([    //step 3 bind data
            ...
            'vaccination_DateTime' => $r->vaccination_DateTime,
    ...
    public function delete($id)
   {
    ...
    public function updateVA()
    {
        ...
        $vas->vaccination_DateTime = $r->vaccination_DateTime;
